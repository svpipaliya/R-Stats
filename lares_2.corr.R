...
df.GBS.variable[ ,c('Colonized', 'Birth_date', 'Blood_samples', 'Consent', 'Exclusion_crit', 'UTI_curr_pregn', 'All_Gr_Neg')] <- list(NULL)
...
df.GBS.variable %>% corr_var(Susceptible, type = 1, max_pvalue = 0.05, ranks = TRUE)
